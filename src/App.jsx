...
import counselorIllustration from './assets/webp/temporary-counselor-illustration-900.webp'
import homeCounselorIllustration from './assets/webp/temporary-home-counselor-illustration-800.webp'
import campusIllustration from './assets/webp/warm-campus-illustration-1000.webp'
import editorialWide from './assets/webp/campus-editorial-wide-1200.webp'
import editorialPortrait from './assets/webp/campus-editorial-portrait-900.webp'
    ...
    <main id="main">
      <section className="hero" id="top" aria-labelledby="hero-title">
        ...
        <div className="sunroom" aria-label="温暖风格的校园插画与人物插画">
          <img className="campus-hero-image" src={campusIllustration} alt="温暖画风的校园林荫大道插画" fetchPriority="high" decoding="async" />
          <div className="hero-portrait-card"><img src={homeCounselorIllustration} alt="胡老师谈话室人物插画" fetchPriority="high" decoding="async" /></div>
      ...
      <section className="about section" id="about" aria-labelledby="about-title">
        ...
        <div className="about-layout"><figure className="portrait-placeholder"><img src={counselorIllustration} loading="lazy" decoding="async" alt="胡老师谈话室人物插画" /></figure><div className="about-copy"><p className="lead">胡老师是{site.role}，<strong>{site.experience}</strong>。</p><p>长期在学生一线工作，让她熟悉大学阶段里那些不容易被一句话说完的困惑：学业的压力、关系的拉扯、对未来的迟疑，以及想要好好长大的心情。</p><p>谈话不是替你下结论，而是在尊重和倾听中，陪你把杂乱的念头一点点理清，找到更适合自己的下一步。</p></div></div>
      </section>
      ...
      <section className="moments section" aria-labelledby="moments-title">
        <div className="moments-visual"><img src={editorialPortrait} loading="lazy" decoding="async" alt="温暖画风的校园树影与湖畔插画" /><p>校园生活并不总是轻松的。<br />但你不必独自消化每一件事。</p></div>
      ...
      <section className="stories section" aria-labelledby="stories-title">
        ...
        <div className="stories-grid"><div className="stories-image"><img src={editorialWide} loading="lazy" decoding="async" alt="温暖画风的校园湖畔与银杏插画" /></div><div className="story-list">{fictionalStories.map(([person, quote, text]) => <article key={person}><p className="story-person">{person}</p><blockquote>{quote}</blockquote><p>{text}</p></article>)}</div></div>
      </section>
      ...
      <section className="faq section" id="faq" aria-labelledby="faq-title"><div className="section-heading narrow"><h2 id="faq-title">常见问题</h2></div><div className="faq-layout"><div className="faq-list">{faqs.map(([question, answer]) => <details key={question}><summary>{question}</summary><p>{answer}</p></details>)}</div><aside className="faq-aside"><img src={editorialPortrait} loading="lazy" decoding="async" alt="温暖画风的校园树影插画" /><div><h3>不必准备好，才可以开口。</h3><p>不确定要说什么也没关系。你可以从“我最近有点乱”开始。</p></div></aside></div></section>
    </main>
